...
String _$projectRepositoryHash() => r'fa8fbce48e5b3b087fefd084da7c29d5ae63535d';
...
/// See also [projectViewRepository].
...
final bucketRepositoryProvider = AutoDisposeProvider<BucketRepository>.internal(
  bucketRepository,
  name: r'bucketRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$bucketRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef BucketRepositoryRef = AutoDisposeProviderRef<BucketRepository>;
...
/// See also [taskCommentRepository].
@ProviderFor(taskCommentRepository)
final taskCommentRepositoryProvider =
    AutoDisposeProvider<TaskCommentRepository>.internal(
      taskCommentRepository,
      name: r'taskCommentRepositoryProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$taskCommentRepositoryHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
